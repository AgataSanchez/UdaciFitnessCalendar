...
import {getMetricMetaInfo, timeToString, getDailyRemainderValue} from '../utils/helpers.js'
...
import TextBotton from './TextButton.js'
import {removeEntry, submitEntry} from '../utils/api.js'
        ...
        if(this.props.alreadyLogged){
            return(
                <View style={styles.center}>
                    ...
                    <TextBotton style={{padding:10}} onPress={this.reset}>Reset</TextBotton>
                </View>
            )
        }
        return(
